...
import AddressStep, { AddressFormData } from "../AddressStep"
import PaymentStep, { PaymentFormData } from "../PaymentStep"
  ...
  const stepComponents: Record<number, JSX.Element> = {
    0: (
      <AddressStep
        ...
        key={`${userAddress?.areaType}-${userAddress?.street}`}
      />
    ),
    1: (
  ...
  return (
    <div className="w-full">
      <Card>
        ...
        {/* Navigation Buttons */}
        <CardFooter className="bg-background sticky bottom-0 border-t">
