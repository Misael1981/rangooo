...
export default async function ProductPage({ params }) {
  ...
  try {
    ...
    try {
      console.error(
        "ProductPage render error",
        {
          slug,
          productId,
          deliveryFeeSnapshot: deliveryFeeBase?.deliveryFee
            ? String(deliveryFeeBase.deliveryFee)
            : null,
        },
        err,
      );
      ...
      console.error(
        "ProductPage render error (failed to stringify snapshot)",
        { slug, productId },
        err,
        logErr,
      );
