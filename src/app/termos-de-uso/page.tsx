...
export default function TermsPage() {
  return (
    <>
      <SecondaryHeader title="Termos e Condições" />
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc space-y-2 pl-6">
                  <li>
                    Os preços podem variar de acordo com o estabelecimento
                  </li>
                  <li>
                    Taxas de entrega são calculadas com base na localização
                  </li>
                  <li>
                    Pedidos confirmados não podem ser cancelados após o início
                    do preparo
                  </li>
                  <li>
                ...
                <ul className="list-disc space-y-2 pl-6">
                  ...
                  <li>
                    Pagamentos online são processados por gateways seguros
                  </li>
                  <li>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                <p className="text-lg font-semibold">
                  ...
                  necessários para proporcionar a melhor experiência de
                  delivery.
                </p>
                ...
                <ul className="list-disc space-y-2 pl-6">
                  <li>
                    <strong>Dados pessoais:</strong> nome, e-mail, telefone -
                    para criar sua conta e entregar pedidos
                  </li>
                  <li>
                    <strong>Localização:</strong> endereço completo - apenas
                    para calcular frete e realizar entregas
                  </li>
                  <li>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg bg-muted p-4">
                  ...
                  <p>
                    <strong>Horário de atendimento:</strong> Segunda a Sábado,
                    8h às 18h
                  </p>
                </div>
